...
@section('content')
    ...
    <div class="datagrid-toolbar" id="toolbar{{ $_mid }}" style="display:inline-block">
        <div style="float:left;">
            @if (count($oris) > 1)
                <select id="foriente" name="foriente" class="easyui-combobox" data-options="panelHeight:500,valueField: 'id',textField: 'text',editable:false,onChange: function(rec){filtrarDatosLog(rec,'oriente');}">
                    <option value="0">Mostrar logias de todos Orientes &nbsp;&nbsp;&nbsp;</option>
        ...
        <div style="float:left;"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="far fa-plus-square blue"  onclick="logia_newItem();">Nuevo Taller</a></div>
        <div style="float:left;"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="fa fa-edit teal"  onclick="logia_editItem();">Editar Taller</a></div>
        ...
        <div style="float:left;"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="far fa-minus-square blue2" onclick="logia_convertir();" id="borrarbtn{{ $_mid }}">Convertir a Triangulo</a></div>
    ...
    <script type="text/javascript">
      ...
      if (row) {
        $.messager.confirm('@lang('mess.question')Confirm', '¿Esta seguro de Convertir esta Logia en Triangulo?', function(r) {
          if (r) {
        ...
        function logia_newItem() {
            $('#dlg{{ $_mid }}').dialog('open').dialog('setTitle', 'Nuevo Logia');
            $('#fm{{ $_mid }}').form('clear');
        ...
        function logia_editItem() {
            ...
            if (row) {
                ...
                $('#dlg{{ $_mid }}').dialog('open').dialog('setTitle', 'Editar logia');
    ...
    <div id="dlg{{ $_mid }}" class="easyui-dialog" style="width:450px;height:auto;padding:5px 5px" closed="true" buttons="#dlgl-buttons{{ $_mid }}" data-options="iconCls:'icon-save',modal:true">
        <form id="fm{{ $_mid }}" method="post" novalidate>
            ...
            <div style="margin-top:0px"><input name="numero" id="numero" label="Numero de la Logia:" labelPosition="left" labelWidth="140" class="easyui-textbox" style="width:100%" required="true"></div>
            <div style="margin-top:0px"><input name="logia" id="logia" label="Nombre corto de la Logia (Sin numero):" labelPosition="top" class="easyui-textbox" style="width:100%" required="true"></div>
            <div style="margin-top:0px"><input name="nombreCompleto" id="nombreCompleto" label="Nombre completo de la Logia:" labelPosition="top" class="easyui-textbox" style="width:100%" required="true"></div>
...
<hr>
            <div style="margin-top:0px"><input name="telefono" label="Telefono:" labelPosition="left" class="easyui-textbox" style="width:100%" ></div>
            <div style="margin-top:0px"><input name="direccion" label="Direccion:" labelPosition="left" class="easyui-textbox" style="width:100%"></div>
            <div style="margin-top:0px"><input name="latitud" label="Latitud:" labelPosition="left" class="easyui-textbox" style="width:100%" ></div>
            <div style="margin-top:0px"><input name="longitud" label="Longitud:" labelPosition="left" class="easyui-textbox" style="width:100%"></div>
        </form>
    </div>
