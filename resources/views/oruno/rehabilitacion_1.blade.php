...
@section('content')
  ...
  <div id="dlg_selm{{ $_mid }}" class="easyui-dialog" style="width:750px;height:500px;padding:0px" closed="true" data-options="iconCls:'icon-save',modal:true">
    ...
    <div class="datagrid-toolbar" id="tba_selm"  style="display:inline-block">
      <div style="float:left;"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="far fa-plus-square fa-lg" onclick="rei_asignar();">Seleccionar obrero</a></div>
    </div>
  </div>
  ...
  <script type="text/javascript">
    ...
    function lrei_sel() {
      ...
      if (logg > 0) {
        ...
        $('#dlg_selm{{ $_mid }}').dialog('open').dialog('setTitle', 'Seleccionar Miembro');
