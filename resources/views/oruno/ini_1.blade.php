...
@section('content')
  ...
  <div class="easyui-layout" data-options="fit:true">
    ...
    <div class="datagrid-toolbar" id="toolbar{{ $_mid }}" style="display:inline-block">
      <div style="float:left;"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="fa fa-plus-square fa-lg correcto" onclick="tini0_newTramite();">Tramite Nuevo</a></div>
  ...
  <script type="text/javascript">
    ...
    function tini0_newTramite() {
      ...
      if (taller > 0) {
        ...
        $('#dlgini0{{ $_mid }}').dialog('open').dialog('setTitle', 'Formulario de registro de tramite para Iniciación');
    ...
    <form id="fmini0{{ $_mid }}" enctype="multipart/form-data" method="post" novalidate>
      ...
      <div id="tt" class="easyui-tabs" style="width:100%;height:auto;">
        <div title="1.- Información Personal" style="padding:8px;display:none;">
          ...
          <div style="margin-bottom:5px"><input class="easyui-textbox" name="apPaterno" style="width:100%" data-options="label:'Primer Apellido*:',required:true" labelWidth="210"></div>
          <div style="margin-bottom:5px"><input class="easyui-textbox" name="apMaterno" style="width:100%" data-options="label:'Segundo Apellido:'" labelWidth="210"></div>
          ...
          <div style="margin-bottom:5px"><input class="easyui-textbox" name="madre" style="width:100%" data-options="label:'Nombres y apellidos de la Madre*:',qureired:true" labelWidth="240"></div>
        </div>
        <div title="2.- Información del tramite" style="padding:8px;display:none;">
          ...
          <div style="margin-bottom:5px"><input class="easyui-filebox" name="cuadernillo" style="width:100%" data-options="label:'Cuaderno de datos*:',required:false,buttonText: 'Escoger PDF'" labelWidth="210" accept=".pdf,.PDF"></div>
          ...
          <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaIniciacion" style="width:80%" data-options="label:'Fecha de Ceremonia de Iniciacion*:',required:true" labelWidth="290"></div>
        </div>
