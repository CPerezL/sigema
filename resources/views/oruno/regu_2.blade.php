  ...
  <div id="dlgini1{{ $_mid }}" class="easyui-dialog" style="width:500px;height:auto;" closed="true" buttons="#dlgini1-buttons{{ $_mid }}" data-options="iconCls:'icon-save',modal:true">
    <form id="fmini1{{ $_mid }}" method="post" novalidate>
      ...
      <div class="easyui-panel" style="width:100%;padding:5px;">
        ...
        <div style="margin-bottom:0px"><input class="easyui-textbox" name="nombre" style="width:100%" data-options="label:'<b>Candidato:<b>',readonly:'true',editable:false,setBorder:'false'" labelWidth="80"></div>
      ...
      <div class="easyui-panel" title="Revision de documentos del Tramite" style="width:100%;padding:5px;">
        ...
        <div style="margin-top:0px">Doc. de Respaldo: <a href="javascript:void(0);" id="abrir_doc" class="easyui-linkbutton c6" iconCls="icon-print" target="_blank" style="width:250px;margin-left:10px;">Ver Archivo</a></div>
        ...
        <div style="margin-bottom:2px"><input class="easyui-textbox" name="fInsinuacion" style="width:80%" data-options="label:'<b>Fecha de Proposición:</b>',readonly:'true',editable:false" labelWidth="270"></div>
        ...
        <div style="margin-bottom:2px"><label for="okactainsinuacion">
            <div style="width:270px;display: inline-block;"><b>Acta  de Proposición:</b></div>
        ...
        <div style="margin-bottom:2px"><input class="easyui-textbox" name="fechaAprobPase" style="width:80%" data-options="label:'<b>Fecha acta de aprobación:</b>',readonly:'true',editable:false" labelWidth="270"></div>
        ...
        <div style="margin-bottom:5px"><label for="okactaaprobacion">
            <div style="width:270px;display: inline-block;"><b>Acta de Aprobación:</b></div>
          </label><input class="easyui-checkbox" id="okactaaprobacion" name="okactaaprobacion" value="1" data-options="label:'<b>Revisado<b>',labelPosition:'after'" labelWidth="80"></div>
            <div style="margin-bottom:2px"><label for="okactaaprobacion">
              ...
              </label><input class="easyui-checkbox" id="okComision" name="okComision" value="1" data-options="label:'<b>Aprobado<b>',labelPosition:'after'" labelWidth="80">
              </div>
    </form>
  </div>
