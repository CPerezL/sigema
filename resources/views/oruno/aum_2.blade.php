  ...
  <script type="text/javascript">
    function revDatos_{{ $_mid }}() {
      ...
      if (row) {
        ...
        $('#dlgauun{{ $_mid }}').dialog('open').dialog('setTitle', 'Revision de tramite para Aumento');
  ...
  <div id="dlgauun{{ $_mid }}" class="easyui-dialog" style="width:450px;height:auto;" closed="true" buttons="#dlgauun-buttons{{ $_mid }}" data-options="iconCls:'icon-save',modal:true">
    <form id="fmini0{{ $_mid }}" method="post" novalidate>
      ...
      <div class="easyui-panel" title="Información del tramite" style="width:100%;padding:5px;">
        <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaIniciacion" style="width:100%" data-options="label:'Fecha de Iniciacion:',readonly:'true',editable:false" labelWidth="260"></div>
        ...
        <div style="margin-bottom:2px"><label for="okPagoDerechos">
        ...
        <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaPase" style="width:100%" data-options="label:'Fecha acta de solicitud de aumento:',required:true" labelWidth="260"></div>
        <div style="margin-bottom:5px"><input class="easyui-textbox" name="actaPase" style="width:100%" data-options="label:'No. Acta 2do Grado solicitud de aumento:',required:true" labelWidth="260"></div>
        <div style="margin-bottom:2px"><label for="okPagoDerechos">
      ...
      <div class="easyui-panel" title="Datos adicionales" style="width:100%;padding:5px;">
        <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaAumento" style="width:100%" data-options="label:'Fecha de Ceremonia de Aumento:',required:true" labelWidth="260"></div>
