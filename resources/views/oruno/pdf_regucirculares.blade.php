...
<body>
  ...
  <footer>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
          {{-- <img src="media/pies.jpg" height="60"> --}}
  ...
  <main>
        ...
        <td>
          ...
          <div class="texto"><b>A LOS HH:. DE LAS LOGIAS DE LA OBEDIENCIA:</b><br>
            ...
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Por disposición del Muy Respetable Gran Maestro y conforme a lo dispuesto por el Artículo. 75°, Inc. 3 del REGLAMENTO DE LAS LOGIAS
              SIMBÓLICAS, os damos a conocer la nómina, antecedentes y fotografías de canditados a ser Hermanos Regulares en las Logias de la Obediencia, la misma que debe ser leida en Tenida de
    ...
    <table width="100%" border="0" cellpadding="0">
      <tr>
        <td>
          <p>Si tenéis alguna observación que hacer, os solicitamos darla a conocer a vuestro Venerable Maestro o a la Gran Secretaria de la Gran Logia Simbolica del Paraguay.</p>
          <p><b>TODA LA INFORMACIÓN RECIBIDA SERA TRATADA CON CARACTER CONFIDENCIAL Y ESTRICTAMENTE RESERVADA.</b></p>
          <p>Con este especial motivo, os hacemos llegar el saludo fraternal de la {{ $region }} en el Valle de {{ $valle }}</p>
        </td>
      </tr>
      <tr>
        <td>
          <center>
            <p><span style="font-variant: small-caps"><b>Fe - Fraternidad - Esperanza</b></span></p>
          </center><br>
        </td>
      </tr>
      <tr>
