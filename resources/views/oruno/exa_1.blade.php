...
@section('content')
    ...
    function newTramite_{{ $_mid }}() {
      ...
      if (row) {
        if (row.pagoOk == '1' && row.antOk == '1') {
          ...
          $('#dlgini0{{ $_mid }}').dialog('open').dialog('setTitle', 'Formulario de tramite para Exaltacion');
  ...
  <div id="dlgini0{{ $_mid }}" class="easyui-dialog" style="width:500px;height:auto;" closed="true" buttons="#dlgini0-buttons{{ $_mid }}" data-options="iconCls:'icon-save',modal:true">
    <form id="fmini0{{ $_mid }}" method="post" novalidate>
      ...
      {{-- <b style="red">*</b></b><div style="margin-bottom:0px;margin-left:5px"><input class="easyui-textbox" name="valle" style="width:100%;" data-options="label:'<b>Valle:</b>',readonly:'true',editable:false" labelWidth="80"></div> --}}
      ...
      <div class="easyui-panel" title="Información del tramite" style="width:100%;padding:5px;">
        ...
        <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaIniciacion" style="width:100%" data-options="label:'Fecha de Iniciacion:',readonly:'true',editable:false" labelWidth="290"></div>
        <div style="margin-bottom:5px"><input class="easyui-textbox" name="actaIniciacion" style="width:100%" data-options="label:'No. Acta 1er Grado - Iniciacion:'" labelWidth="290"></div>
        <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaAumento" style="width:100%" data-options="label:'Fecha de Aumento:',readonly:'true',editable:false" labelWidth="290"></div>
        <div style="margin-bottom:5px"><input class="easyui-textbox" name="actaAumento" style="width:100%" data-options="label:'No. Acta 2do Grado - Aumento:'" labelWidth="290"></div>
        <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaPase" style="width:100%" data-options="label:'Fecha de acta de solicitud de Exaltación*:',required:true" labelWidth="290"></div>
        <div style="margin-bottom:5px"><input class="easyui-textbox" name="actaPase" style="width:100%" data-options="label:'No. Acta 3er Gr. de solicitud de Exaltación*:',required:true" labelWidth="290"></div>
        <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaExamen" style="width:100%" data-options="label:'Fecha de examen de Exaltacion*:',required:true" labelWidth="290"></div>
        <div style="margin-bottom:10px"><input class="easyui-textbox" name="actaExamen" style="width:100%" data-options="label:'No. Acta 2do Grado Examen de Exaltación*:',required:true" labelWidth="290"></div>
        <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaExaltacion" style="width:100%" data-options="label:'Fecha de Ceremonia de Exaltación*:',required:true" labelWidth="290"></div>
