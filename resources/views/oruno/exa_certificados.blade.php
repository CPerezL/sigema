  ...
  <script type="text/javascript">
    ...
    function revDatos_{{ $_mid }}() {
      ...
      if (row) {
        ...
        $('#fmexa2{{ $_mid }}').form('load', '{{ $_controller }}/get_tramites?_token=' + tokenModule + '&id=' + row.idTramite); // load from URL
    ...
    <form id="fmexa2{{ $_mid }}" enctype="multipart/form-data" method="post" novalidate>
      ...
      <div class="easyui-panel" title="Revision de derechos de Ceremonia y Cetificación" style="width:100%;padding:5px;">
        <div style="margin-bottom:2px"><label for="certificado1">
            ...
            <input class="easyui-checkbox" id="certificado1" name="certificado1" value="1" data-options="label:'<b>Autorizado<b>',labelPosition:'after'" labelWidth="80">
        </div>
    </form>
  </div>
