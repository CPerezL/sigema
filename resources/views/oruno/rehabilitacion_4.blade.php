...
@section('content')
  ...
  <div class="datagrid-toolbar" id="toolbar{{ $_mid }}"  style="display:inline-block">
    @if (Auth::user()->permisos == 1)
      @if ((Auth::user()->nivel == 1 && Auth::user()->permisos == 2) || Auth::user()->nivel > 4)
        <div style="float:left;"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="fa fa-check-square-o fa-lg correcto" onclick="rei_aprobar();">Revisar Pago</a></div>
      @endif
  ...
  <div id="dl3{{ $_mid }}" class="easyui-dialog" style="width:500px;height:auto;" closed="true" buttons="#regder_but{{ $_mid }}" data-options="iconCls:'icon-save',modal:true">
    <form id="fm3{{ $_mid }}" enctype="multipart/form-data" method="post" novalidate>
      <div class="easyui-panel" title="Miembro para rehabilitar" style="width:100%;padding:5px;">
        <div style="margin-top:0px"><input name="NombreCompleto" id="miembro" label="Miembro:" labelPosition="left" labelWidth="80" class="easyui-textbox" style="width:100%" readonly="true"></div>
      </div>
      <div class="easyui-panel" title="Pago de derechos de rehabilitacion" style="width:100%;padding:5px;">
        <div style="margin-bottom:15px"><input class="easyui-datebox" name="fechaDeposito" style="width:100%" data-options="label:'<b>Fecha de Pago de Derechos*: </b>'" labelWidth="210"></div>
        <div style="margin-bottom:15px">
          <label><b>Documento de deposito o transf. bancaria</b></label>
  ...
  <div id="dlg_selm{{ $_mid }}" class="easyui-dialog" style="width:750px;height:500px;padding:0px" closed="true" data-options="iconCls:'icon-save',modal:true">
    <table id="dg_reisel" style="width:auto;height:auto"></table>
    <div class="datagrid-toolbar" id="tba_selm"  style="display:inline-block">
      <div style="float:left;"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="far fa-plus-square fa-lg" onclick="rei_asignar();">Seleccionar miembro en sueño</a></div>
    </div>
  </div>
  <div id="dlg{{ $_mid }}" class="easyui-dialog" style="width:450px;height:auto;padding:5px 5px" closed="true" buttons="#dlgl-buttons{{ $_mid }}" data-options="iconCls:'icon-save',modal:true">
    <form id="fm{{ $_mid }}" method="post" novalidate>
      ...
      <div style="margin-top:2px">
        ...
        <input name="observaciones" class="easyui-textbox" multiline="true" onRead="onRead" style="width:100%; height:120px" required="true"/>
      </div>
    </form>
  </div>
  ...
  <div id="dlg4{{ $_mid }}" class="easyui-dialog" style="width:450px;height:auto;padding:5px 5px" closed="true" buttons="#dlgl-buttons4{{ $_mid }}" data-options="iconCls:'icon-save',modal:true">
    <form id="fm4{{ $_mid }}" method="post" novalidate>
      ...
      <div style="margin-top:2px"><input class="easyui-datebox" name="fechaDeposito" style="width:95%" data-options="label:'Fecha de deposito:'" labelWidth="200" readonly="true"></div>
      <div style="margin-top:10px;margin-bottom:10px">Deposito: <a href="javascript:void(0)" id="abrir_dep" class="easyui-linkbutton c6" iconCls="icon-print" target="_blank" style="width:300px;margin-left:10px;">Ver deposito de obolos adeudados</a></div>
