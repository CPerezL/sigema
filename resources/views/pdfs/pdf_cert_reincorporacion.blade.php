  ...
  <div style="font-size:11px; line-height: 1.6;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="40%">
          <div align="center">
            <h2>GRAN LOGIA DE BOLIVIA<br>CERTIFICACIÓN DE DEPOSITO<BR>Departamento de Contabilidad</h2>
          </div>
        </td>
    ...
    <blockquote>
      <div style="font-size:14px; text-align: justify;">
        <p>El presente documento CERTIFICA la recepcion del pago para la reincoporación a la Orden, para el Hermano: {{ $profano }}, Deposito/Trasferencia en fecha {{ strtoupper($fechadep) }}
