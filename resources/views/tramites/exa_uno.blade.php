  ...
  $(function () {
    var dg{{ $_mid }} = $('#dg{{ $_mid }}').datagrid({
      ...
      columns: [[
          ...
          {field: 'NombreCompleto', title: 'Q:.H:.C:.'},
...
<div id="dlgauun{{ $_mid }}" class="easyui-dialog" style="width:450px;height:auto;" closed="true" buttons="#dlgauun-buttons{{ $_mid }}"
  ...
  <form id="fmini0{{ $_mid }}" method="post" novalidate>
    ...
    <div style="margin-bottom:0px;margin-left:5px"><input class="easyui-textbox" name="compaName" style="width:100%;" data-options="label:'<b>C:.M:.</b>',readonly:'true',editable:false" labelWidth="80"></div>
    <div class="easyui-panel" title="Información del tramite" style="width:100%;padding:5px;">
      ...
      <div style="margin-bottom:2px"><label for="okPagoIniciacion"><div style="width:290px;display: inline-block;"><b>Iniciacion:</b></div></label><input class="easyui-checkbox" id="okIniciacion" name="okIniciacion" value="1" data-options="label:'<b>Revisado<b>',labelPosition:'after'" labelWidth="60"></div>
      ...
      <div style="margin-bottom:2px"><label for="okAumento"><div style="width:290px;display: inline-block;"><b>Aumento de Salario:</b></div></label><input class="easyui-checkbox" id="okAumento" name="okAumento" value="1" data-options="label:'<b>Revisado<b>',labelPosition:'after'" labelWidth="60"></div>
      ...
      <div style="margin-bottom:2px"><label for="okSolicitud"><div style="width:290px;display: inline-block;"><b>Solicitud:</b></div></label><input class="easyui-checkbox" id="okSolicitud" name="okSolicitud" value="1" data-options="label:'<b>Revisado<b>',labelPosition:'after'" labelWidth="60"></div>
      <div style="margin-bottom:2px"><input class="easyui-datebox" name="fechaExamen" style="width:100%" data-options="label:'Fecha de examen de Aumento de Salario:',required:true" labelWidth="260"></div>
      <div style="margin-bottom:5px"><input class="easyui-textbox" name="actaExamen" style="width:100%" data-options="label:'No. Acta 2do Grado de examen de aumento:',required:true" labelWidth="260"></div>
      <div style="margin-bottom:2px"><label for="okExamen"><div style="width:290px;display: inline-block;"><b>Examen:</b></div></label><input class="easyui-checkbox" id="okExamen" name="okExamen" value="1" data-options="label:'<b>Revisado<b>',labelPosition:'after'" labelWidth="60"></div>
    </div>
    <div class="easyui-panel" title="Datos adicionales" style="width:100%;padding:5px;">
      <div style="margin-bottom:2px"><label for="okTrabajos"><div style="width:290px;display: inline-block;"><b>Trabajos presentados:</b></div></label><input class="easyui-checkbox" id="okTrabajos" name="okTrabajos" value="1" data-options="label:'<b>Revisado<b>',labelPosition:'after'" labelWidth="60"></div>
      <div style="margin-bottom:2px"><label for="okAsistencia"><div style="width:290px;display: inline-block;"><b>Asistencias:</b></div></label><input class="easyui-checkbox" id="okAsistencia" name="okAsistencia" value="1" data-options="label:'<b>Revisado<b>',labelPosition:'after'" labelWidth="60"></div>
    </div>
  </form>
</div>
