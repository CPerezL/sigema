...
@section('content')
  ...
  <div class="easyui-layout" data-options="fit:true">
    ...
    <div class="datagrid-toolbar" id="toolbar{{ $_mid }}" style="display:inline-block">
      <div style="float:left;"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="fa fa-check-square fa-lg correcto" onclick="revDatos_{{ $_mid }}();">Verificar tramite</a></div>
  ...
  <div id="dlgauun{{ $_mid }}" class="easyui-dialog" style="width:450px;height:auto;" closed="true" buttons="#dlgauun-buttons{{ $_mid }}" data-options="iconCls:'icon-save',modal:true">
    <form id="fmini0{{ $_mid }}" method="post" novalidate>
      ...
      <div class="easyui-panel" title="Información del tramite" style="width:100%;padding:5px;">
        ...
        <div style="margin-bottom:5px"><input class="easyui-textbox" name="actaPase" style="width:100%" data-options="label:'No. Acta 2do Grado de solicitud de pase:',required:true" labelWidth="260"></div>
        <div style="margin-bottom:2px"><label for="okPagoDerechos">
