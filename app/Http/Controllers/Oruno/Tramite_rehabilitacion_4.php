...
class Tramite_rehabilitacion_4 extends Controller
{
     ...
     */
    public $idmod = '055';
    public $controlador = 'tramite_rehabilitacion_4';
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('oruno.rehabilitacion_4', $data);
    }
...
//--
            $pdf = PDF::loadView('oruno.pdf_cert_rehabilitacion', $data);
