...
class Oruno_tramite_ini_4 extends Controller
{
     ...
     */
    public $idmod = '092';
    public $controlador = 'oruno_tramite_ini_4';
    ...
    public function get_datos(Request $request)
    {
        ...
        $qry = Iniciacion_model::getTramitesListos($page, $rows, Session::get($this->controlador . '.palabra', ''), $log, $val, 3, 0, $dias);
        $total = Iniciacion_model::getNumTramitesListos(Session::get($this->controlador . '.palabra', ''), $log, $val, 3, 0, $dias);
