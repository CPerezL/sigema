...
class Oruno_tramite_regu_5 extends Controller
{
     ...
     */
    public $idmod = '095';
    public $controlador = 'oruno_tramite_regu_5';
    public $tipoqr = 2;
    ...
    public function get_datos(Request $request)
    {
        ...
        $salida = Regularizacion_model::getTramitesPagar($page, $rows, Session::get($this->controlador . '.palabra', ''), $log, $val, 3, 0, $dias);//emcircularizacioh
        $total = Regularizacion_model::getNumTramitesPagar(Session::get($this->controlador . '.palabra', ''), $log, $val, 3, 0, $dias);
    ...
    public function get_ceremonia(Request $request)
    {
        $id = $request->input('id');
        if ($id > 0) {
            $salida = Regularizacion_model::getTramiteRegu($id, 2);
        } else {
