...
class Oruno_tramite_regu_2 extends Controller
{
     ...
     */
    public $idmod = '040';
    public $controlador = 'oruno_tramite_regu_2';
    ...
    public function get_datos(Request $request)
    {
        ...
        $qry = Regularizacion_model::getRegistros($page, $rows, Session::get($this->controlador . '.palabra', ''), $log, $val, 1);
        $total = Regularizacion_model::getNumRegistros(Session::get($this->controlador . '.palabra', ''), $log, $val, 1);
    ...
    public function get_tramite(Request $request)
    {
        ...
        if ($tramite > 0) {
            $salida = Regularizacion_model::getTramiteRegu($tramite, 1);
    ...
    public function update_tramite(Request $request)
    {
        ...
        if ($id > 0) {
            ...
            $ok6 = $request->input('okComision', 0);
