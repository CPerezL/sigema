...
class Oruno_tramite_aum_2 extends Controller
{
     ...
     */
    public $idmod = '084';
    public $controlador = 'oruno_tramite_aum_2';
    ...
    public function get_datos(Request $request)
    {
        ...
        $qry = Aumento_model::getRegistros($page, $rows, Session::get($this->controlador . '.palabra', ''), $log, $val, 0);
        $total = Aumento_model::getNumRegistros(Session::get($this->controlador . '.palabra', ''), $log, $val, 0);
    ...
    public function update_tramite(Request $request)
    {
        ...
        if ($id > 0) {
            ...
            $sum = $okasi + $okini + $oksol + $okexa + $oktra+$okex;
            $datas = array(
                'okIniciacion' => $okini,
                'okSolicitud' => $oksol,
                'okExamen' => $okexa,
