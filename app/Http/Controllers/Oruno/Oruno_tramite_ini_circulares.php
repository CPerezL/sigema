...
use App\Models\oruno\Iniciacion_circulares_model;
use App\Traits\DatagridTrait;
use Illuminate\Http\Request;
use PDF;
use Session;

class Oruno_tramite_ini_circulares extends Controller
{
     ...
     */
    public $idmod = '082';
    public $controlador = 'oruno_tramite_ini_circulares';
    public $filename = '';
    public $paginas = 1;
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('oruno.ini_circulares', $data);
    }
    ...
    public function gen_circular(Request $request)
    {
        ...
        $pdf = PDF::loadView('oruno.pdf_circulares', $data);
    ...
    <td>' . ($info->nombres) . '<br>' . ($info->apPaterno) . ' ' . ($info->apMaterno) . '</td></tr>
