...
class Tramite_rehabilitacion_3 extends Controller
{
     ...
     */
    public $idmod = '055';
    public $controlador = 'tramite_rehabilitacion_3';
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('oruno.rehabilitacion_3', $data);
    }
    ...
    public function get_miembros(Request $request)
    {
        ...
        if ($id > 0) {
            ...
            $salida = Rehabilitaciones_model::getMiembros($id, $filtro);
        ...
        if ($id > 0) {
            ...
            if (strlen($archivo) > 10) {
                $data = array(
                    'estado' => 3,
                    'archivo' => $archivo,
                    'fechaDeposito' => \DateTime::createFromFormat('d/m/Y', $request->input('fechaDeposito', '00-00-0000'))->format('Y-m-d'),
                    'fechaModificacion' => date('Y-m-d h:m:s'),
                );
                $resu = Rehabilitaciones_model::where('id', $id)->update($data);
                if ($resu > 0) {
