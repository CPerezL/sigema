...
class Tramites_ini_seis extends Controller
{
     ...
     */
    public $idmod = '098';
    public $controlador = 'tramites_ini_seis';
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('tramites.ini_seis', $data);
    }
    public function get_datos(Request $request)
    {
        ...
        $qry = Iniciacion_model::getTramitesListos($page, $rows, Session::get($this->controlador . '.palabra', ''), $log, $val, 7);
        $total = Iniciacion_model::getNumTramitesListos(Session::get($this->controlador . '.palabra', ''), $log, $val, 7);
