...
class Tramites_exa_certificados extends Controller
{
     ...
     */
    public $idmod = '032';
    public $controlador = 'tramites_exa_certificados';
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('tramites.exa_certificados', $data);
    }
    public function get_datos(Request $request)
    {
        ...
        $qry = Exaltacion_model::getItems($page, $rows, Session::get($this->controlador . '.palabra', ''), $log, $val);
        $total = Exaltacion_model::getNumItems(Session::get($this->controlador . '.palabra', ''), $log, $val);
