...
class Tramites_exa_pagarqr extends Controller
{
     ...
     */
    public $idmod = '090';
    public $controlador = 'tramites_exa_pagarqr';
    public $tipoqr = 4;
    ...
    public function index(Request $request)
    {
        ...
        /*     variables de pagina     */
        return view('tramites.exa_pagarqr', $data);
    }
    public function get_datos(Request $request)
    {
        ...
        $salida = Pagosqr_model::getExaltados($page, $rows, $palabra, $valle, $taller, $pago);
        $total = Pagosqr_model::getNumCeremoniasExa($palabra, $valle, $taller, $pago);//modificar
    ...
    public function get_ceremonia(Request $request)
    {
        ...
        if ($cere > 0) {
            $salida = Pagosqr_model::getCeremoniaPago($cere, $num, 4);
        } else {
    ...
    public function get_datos_pagos(Request $request)
    {
        ...
        $datos = Pagosqr_model::getDatosExa($reg, Auth::user()->id, $this->tipoqr); //datos de obolos del miembro
        $datos->user = Auth::user()->id;
        $datos->idCeremonia = $reg;
        $datos->tipo =$this->tipoqr;
        $datos->Miembro = 'Exaltacion';
        $datos->grado = 3;
