...
class Tramites_aum_cuatro extends Controller
{
     ...
     */
    public $idmod = '091';
    public $controlador = 'tramites_aum_cuatro';
    public $tipoqr = 3;
    ...
    public function index(Request $request)
    {
        ...
        /*     variables de pagina     */
        return view('tramites.aum_cuatro', $data);
    }
    public function get_datos(Request $request)
    {
        ...
        $salida = Aumento_model::getCeremonias($page, $rows, $palabra, $valle, $taller, $pago);
        $total = Aumento_model::getNumCeremonias($palabra, $valle, $taller, $pago);
    ...
    public function get_ceremonia(Request $request)
    {
        ...
        if ($cere > 0) {
            $salida = Aumento_model::getCeremoniaAum($cere);
        } else {
