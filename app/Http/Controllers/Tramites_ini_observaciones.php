...
class Tramites_ini_observaciones extends Controller
{
     ...
     */
    public $idmod = '101';
    public $controlador = 'tramites_ini_observaciones';
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('tramites.ini_observaciones', $data);
    }
    public function get_datos(Request $request)
    {
        ...
        $qry = Observaciones_model::getRegistros($page, $rows, Session::get($this->controlador . '.palabra', ''), $log, 0, 1);
        $total = Observaciones_model::getNumRegistros(Session::get($this->controlador . '.palabra', ''), $log, 0, 1);
