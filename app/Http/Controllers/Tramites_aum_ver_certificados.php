...
use App\Models\tramites\Certificados_model;
...
class Tramites_aum_ver_certificados extends Controller
{
    ...
    public $idmod = '077';
    public $controlador = 'tramites_aum_ver_certificados';
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('tramites.aum_ver_certificados', $data);
    }
    ...
    public function gen_reporte(Request $request)
    {
        ...
        if ($id > 0) {
            ...
            $data['ritocert'] = 'Segundo Grado Simbólico del ' . $ritotxt;
            ...
            $data['tipocert'] = 'CERTIFICADO DE COMPAÑERO';
            ...
            $pdf = PDF::loadView('pdfs.pdf_qr_certificado', $data);
