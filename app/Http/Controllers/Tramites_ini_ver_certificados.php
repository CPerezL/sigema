...
class Tramites_ini_ver_certificados extends Controller
{
    ...
    public $idmod = '076';
    public $controlador = 'tramites_ini_ver_certificados';
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('tramites.ini_ver_certificados', $data);
    }
    public function get_datos(Request $request)
    {
        ...
        $qry = Certificados_model::getIniciados($page, $rows, Session::get($this->controlador . '.palabra', ''), $log, $val);
        $total = Certificados_model::getNumIniciados(Session::get($this->controlador . '.palabra', ''), $log, $val);
