...
class Miembros_meritos extends Controller
{
     ...
     */
    public $idmod = '102';
    public $controlador = 'miembros_meritos';
    ...
    public function index(Request $request)
    {
        ...
        /*     varibles de pagina* */
        return view('admin.meritos', $data);
    }
    public function get_datos(Request $request)
    {
        ...
        $qry = Meritos_model::getRegistros($page, $rows, Session::get($this->controlador . '.palabra', ''), $val, $log, Session::get($this->controlador . '.estado', 0));
        $total = Meritos_model::getNumRegistros(Session::get($this->controlador . '.palabra', ''), $val, $log, Session::get($this->controlador . '.estado', 0));
