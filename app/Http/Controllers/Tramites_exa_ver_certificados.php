...
class Tramites_exa_ver_certificados extends Controller
{
    ...
    public $idmod = '078';
    public $controlador = 'tramites_exa_ver_certificados';
    ...
    public function gen_reporte(Request $request)
    {
        ...
        if ($id > 0) {
            ...
            $data['ritocert'] = 'Tercer Grado Simbólico del ' . $ritotxt;
            ...
            $data['tipocert'] = 'CERTIFICADO DE MAESTRO';
            $data['numecert'] = 'M.-' . str_pad($dcere->numeroCertificado, 7, "0", STR_PAD_LEFT);
